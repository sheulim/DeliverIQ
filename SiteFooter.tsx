export default function SiteFooter(){
 ...
 return <footer style={{background:"#050b1d",color:"#fff",padding:"44px 32px 24px",marginTop:40}}>
  <div style={{maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"minmax(280px,1.5fr) repeat(2,minmax(170px,.7fr))",gap:34}}>
   ...
   <div><b>Resources</b><div style={{display:"grid",gap:13,marginTop:18,color:"#cbd5e1"}}><a href="/playbooks" style={{color:"inherit",textDecoration:"none"}}>Playbooks</a><a href="/templates" style={{color:"inherit",textDecoration:"none"}}>Free Templates</a><a href="/learn" style={{color:"inherit",textDecoration:"none"}}>Learning Hub</a><a href="/newsletter" style={{color:"inherit",textDecoration:"none"}}>Newsletter</a><a href="/metrics" style={{color:"inherit",textDecoration:"none"}}>Metrics Intelligence</a><a href="/metrics/dashboard" style={{color:"inherit",textDecoration:"none"}}>Dashboard Builder</a><a href="/prompt-library" style={{color:"inherit",textDecoration:"none"}}>Prompt Library</a></div></div>
   <div><b>AI & Product</b><div style={{display:"grid",gap:13,marginTop:18,color:"#cbd5e1"}}><a href="/ai-lab" style={{color:"inherit",textDecoration:"none"}}>AI Lab</a><a href="/ai-future" style={{color:"inherit",textDecoration:"none"}}>AI Future</a><a href="/login" style={{color:"inherit",textDecoration:"none"}}>Project Workspace</a><a href="/integrations" style={{color:"inherit",textDecoration:"none"}}>Integration & Agent Hub</a><a href="/prooflayer" style={{color:"inherit",textDecoration:"none"}}>ProofLayer AI</a></div></div>
  </div>
